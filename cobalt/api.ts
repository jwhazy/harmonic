...
export class Cobalt {
	...
	// I don't use a public instance of Cobalt, so I've got an LLM to generate the method.
	// I'm not sure if it's correct, but let me know if it doesn't.

	/**
	 * WARNING: Generated by LLM, not tested and may break.
	 *
